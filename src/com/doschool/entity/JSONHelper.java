...
public class JSONHelper {
	 ...
	 * @param array	数组
	 */
	public static void serializeArray(JSONStringer js, Object array) {
		try {
			js.array();
	 ...
	 * @param collection	集合
	 */
	public static void serializeCollect(JSONStringer js, Collection<?> collection) {
		try {
			js.array();
	 ...
	 * @param map	map对象
	 */
	public static void serializeMap(JSONStringer js, Map<?,?> map) {
		try {
			js.object();
...
//            Log.e(TAG, TAG  + ">>>>>>>>>>set value error.",e);
	 ...
	 * @param jo	json实例
	 */
	public static void setField(Object obj, JSONObject jo) {
		try {
			@SuppressWarnings("unchecked")
	 ...
	 * @param jo	json实例
	 */
	public static void setField(Object obj, Method fieldSetMethod,Field field, JSONObject jo) {
...
//				}
	...
	public static void setField(Object obj, Field field, JSONObject jo) {
		String name = field.getName();
		Class<?> clazz = field.getType();
		try {
			if (isArray(clazz)) { // 数组
