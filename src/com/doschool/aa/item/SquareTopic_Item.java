...
public class SquareTopic_Item extends LinearLayout {
	...
	// 初始化界面
	public SquareTopic_Item(Context context) {
		super(context);
		createUI();
	}

	public SquareTopic_Item(Context context, AttributeSet attrs) {
		super(context, attrs);
		createUI();
	}
	...
	private void createUI() {
		...
		inflater.inflate(R.layout.item_square_topic, this);
	...
	public void updateUI(Topic data) {
		...
		tvTopic.setText(topicData.topic);
