...
public abstract class Fgm_Standard_Relative extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mParent = new RelativeLayout(getActivity());
		mParent.setBackgroundColor(getResources().getColor(R.color.bg_yellow));
